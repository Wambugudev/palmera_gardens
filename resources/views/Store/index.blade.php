        ...
        <div class="row justify-content-center">
            <div class="col-md-8 ">
                <div class="card fs-4 " style="margin-top: 100px; opacity:90%;">
                    <div class="card-header text-center text-light bg-primary "><h5>Palmera Stores(Store User)</h5></div>
    
                    <div class="card-body " style="opacity: 500%">
                        <div class="row">
                            <a class="text-center text-dark badge badge-light" href="http://">
                                <div class="col mt-2 pt-4">
                                    <img src="/media/svg/bar.svg" alt="Bootstrap" width="250px" height="250px" style="color: red" >
                                    <br>
                            ...
                            <div class="col">
                                <a class="text-center text-dark badge badge-light" href="http://">
                                    <div class="col mt-2 pt-4">
                                        <img src="/media/svg/kitchen.svg" alt="Bootstrap" width="250px" height="250px" style="color: red" >
                                        <br>
